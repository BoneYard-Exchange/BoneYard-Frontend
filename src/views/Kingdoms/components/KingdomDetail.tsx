    ...
    <KDetail>
      ...
      <Details className="k-details">
        <Detail>
          ...
          {altPid === 12 ? (
            <CubKingdom>*BOYD Kingdom multiplier coexists with BOYD Den multiplier</CubKingdom>
          ) : (
            <Flex justifyContent="space-between">
              <Text>Farm:</Text>
              <Text>{farmName}</Text>
        ...
        <Detail>
          <StyledLinkExternal external href={farmContract}>
            Farm Contract
          </StyledLinkExternal>
          <StyledLinkExternal external href={vaultContract}>
            Kingdom Contract
          </StyledLinkExternal>
          {!removed && (
            <>
