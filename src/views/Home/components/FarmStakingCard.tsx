...
import { Heading, Card, CardBody, Button, Flex } from '@boneyard/uikit'
...
const StyledFarmStakingCard = styled(Card)`
  background-image: url('/images/cub/boyd-bg.png');
  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <CardImage src="/images/cub/BOYD_token.png" alt="cub logo" width={64} height={64} />
        <Flex justifyContent='space-between'>
          <div>
            <Block>
              <Label>{TranslateString(544, 'BOYD to Harvest')}:</Label>
              <CakeHarvestBalance />
            </Block>
            <Block>
              <Label>{TranslateString(546, 'BOYD in Wallet')}:</Label>
              <CakeWalletBalance />
            </Block>
            <Actions>
              {account ? (
                ...
                >
                  {pendingTx
                    ? TranslateString(548, 'Collecting BOYD')
