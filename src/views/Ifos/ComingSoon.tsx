...
import { Button, Text } from '@boneyard/uikit'
  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to BOYDefi.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
                'You’ll pay for the new tokens using CUB-BNB LP tokens, which means you need to stake equal amounts of BOYD and BNB in a liquidity pool to take part.',
              )}
            </Text>
            <Text mb={3}>
              <LiquidityLink href="https://pancakeswap.finance/liquidity">
                {TranslateString(506, 'Get BOYD-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, BOYDefi burns the BOYD.')}
              <br />
        ...
        <div>
          <MainImage src="/images/cub/BOYD_Farm.png" alt="ifo bunny" />
        </div>
      </Content>
    </Page>
  )
