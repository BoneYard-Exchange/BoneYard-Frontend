  ...
  return (
    <StyledHero>
      <Container>
        ...
        <Heading as="h2" color="secondary">{TranslateString(502, 'Participate in new platform tokens via decentralized IDOs! 50% of the raise burns BOYD and 50% goes to the project team who initiated the IDO.')}</Heading>
        <br />
        <Wrapper>
          <Button size="sm">
