...
export const getUNIamount = async () => {
  // 0xB631299Ed1Db9B7152D24E65b724bc9F53cA0b40: Main staking contract
  // 0x77440f4dc7b4ef591e78d460374bd12d3d6bdad8: UNI LockedKingdom vault  (BOYDMaxmizer address)
  const contract = new web3.eth.Contract(PCS_ABI, '0xB631299Ed1Db9B7152D24E65b724bc9F53cA0b40')
  const call = await contract.methods.userInfo(3, '0x5961386e647697551310271792c6852f845dd166').call()
  return call.amount
}
...
export const getBTCBNBBakeryAmount = async () => {
  ...
  const call = await contract.methods
    .poolUserInfoMap('0x58521373474810915b02fe968d1bcbe35fc61e09', '0xbdc40a031f6908a8203fb1c75bb2b9c4abf59e2e')
    .call()
  return call.amount
}
...
export const getBeltAPR = async () => {
  return axios
    .get(process.env.REACT_APP_BELT_SCRAPE, { timeout: 3000 })
